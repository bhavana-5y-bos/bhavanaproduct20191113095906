...
namespace BOS.StarterCode.Tests
{
    ...
    {
        [Fact]
        public void NavigateToModule_redirects_to_home_view_with_modelstateerror_when_code_is_null()
        {
            //Arrange
            ...
            Assert.Equal("NavigationMenu", redirectResult.ActionName); //Asseting that the Action Methond of the controller is "NavigationMenu"
            Assert.True(controller.ViewData.ModelState.Count == 1);
        }

        [Fact]
        public void NavigateToModule_redirects_to_home_view_when_code_is_custom()
        {
            //Arrange
            var controller = new NavigationController();
        ...
        public void NavigateToModule_redirects_to_predefined_view_when_code_is_bos_defined_profile()
        {
            ...
            //Assert
            var redirectResult = Assert.IsType<RedirectToActionResult>(result); //Asserting that the return is a View
            Assert.Equal("Profile", redirectResult.ControllerName); //Asseting that the returned Controller is "Profile"
        ...
        public void NavigateToModule_redirects_to_predefined_view_when_code_is_bos_defined_users()
        {
            ...
            //Assert
            var redirectResult = Assert.IsType<RedirectToActionResult>(result); //Asserting that the return is a View
            Assert.Equal("Users", redirectResult.ControllerName); //Asseting that the returned Controller is "Users"
            Assert.Equal("Index", redirectResult.ActionName); //Asseting that the Action Methond of the controller is "Index"
        }
        ...
        public void NavigateToModule_redirects_to_predefined_view_when_code_is_bos_defined_roles()
        {
            ...
            //Assert
            var redirectResult = Assert.IsType<RedirectToActionResult>(result); //Asserting that the return is a View
            Assert.Equal("Roles", redirectResult.ControllerName); //Asseting that the returned Controller is "Roles"
            Assert.Equal("Index", redirectResult.ActionName); //Asseting that the Action Methond of the controller is "Index"
        }
        ...
        public void NavigateToModule_redirects_to_predefined_view_when_code_is_bos_defined_permissions()
        {
            ...
            //Assert
            var redirectResult = Assert.IsType<RedirectToActionResult>(result); //Asserting that the return is a View
            Assert.Equal("Permissions", redirectResult.ControllerName); //Asseting that the returned Controller is "Permissions"
            Assert.Equal("Index", redirectResult.ActionName); //Asseting that the Action Methond of the controller is "Index"
        }
    }
}
