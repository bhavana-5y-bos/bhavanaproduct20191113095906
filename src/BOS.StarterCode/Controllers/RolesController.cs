...
namespace BOS.StarterCode.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        {
            return View("AddRole", await GetPageData());
        }
        ...
        public async Task<string> AddRole([FromBody]JObject data)
        {
            try
            {
                ...
                if (role != null)
                {
                    ...
                    {
                        return ("The role was added successfully");
                    }
                    else
                    {
                ...
                {
                    return ("The data inputted for role is inaccurate.Please try again.");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<string> UpdateRole([FromBody] JObject data)
        {
            try
            {
                ...
                {
                    return "The inputted data was inaccurate. Please try again.";
                }
            }
            catch (Exception ex)
            {
